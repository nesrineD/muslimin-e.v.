...
export default function PublicLandingPage() {
  ...
  return (
    ...
    >
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-cream-50 via-white to-sage-50/30">
        <motion.div
          variants={itemVariants}
          initial="hidden"
          whileInView="visible"
        ...
        >
          <div className="text-center mb-10">
            <motion.h2
              ...
              viewport={{ once: true }}
              className="text-3xl md:text-4xl font-bold mb-4 text-sage-800"
            >
              Wer sind wir?
            </motion.h2>
      ...
      <section className="py-16 md:py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-sage-100/40 via-white to-cream-50/30">
        <motion.div variants={itemVariants} className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-charcoal-800 mb-4">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <motion.div
          variants={itemVariants}
          className="max-w-4xl mx-auto bg-gradient-to-r from-sage-600 via-sage-700 to-coral-600 rounded-3xl p-12 text-center text-white shadow-2xl"
        >
          <motion.div
