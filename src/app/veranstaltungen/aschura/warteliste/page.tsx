...
import { WaitlistForm } from "@/components/aschura/WaitlistForm";
    ...
    <main className="min-h-screen bg-charcoal-900">
      <div className="container mx-auto px-4 py-16 max-w-lg">
        <div className="text-center mb-10">
          <p className="mb-3 text-xs font-semibold uppercase tracking-[0.28em] text-red-300">
          ...
          <p className="text-charcoal-300 text-sm max-w-sm mx-auto">
            Alle Plätze sind vergeben. Trag dich in die Warteliste ein — wir
            benachrichtigen dich, sobald ein Platz frei wird.
          </p>
        </div>
