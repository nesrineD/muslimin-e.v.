...
export const FOOTER_BRIDGE_SURFACE_CLASS =
  "rounded-[2rem] border border-sand-300/55 bg-gradient-to-br from-sand-100/92 via-cream-100/88 to-sage-100/74 shadow-[0_22px_55px_-38px_rgba(50,46,42,0.28)] backdrop-blur-sm";

/** Shared prominent closing surface for final CTA sections above the footer. */
export const CLOSING_SECTION_SURFACE_CLASS =
  "rounded-[2.25rem] border border-sand-300/65 bg-gradient-to-br from-sand-100/95 via-cream-100/92 to-sage-100/80 shadow-[0_26px_70px_-36px_rgba(50,46,42,0.32)] backdrop-blur-sm";
